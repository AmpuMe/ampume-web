...
export const LINER_DESCRIPTIONS = {
  ...
  'Alpha Classic BK Cushion': {
    sizingType: 'alpha-bk',
    shortDescription: 'Designed for below-knee prosthetic users, the Alpha Classic liner uses a skin-friendly gel with mineral oil and Vitamin E to deliver comfort and protection. The gel adapts to changing socket pressures while maintaining shape, supporting a consistent fit and dependable performance.',
    overview: [
  ...
  'EasyLiner': {
    ...
    shortDescription: 'Designed for both above-knee and below-knee prosthetic users, the EasyLiner provides comfort, skin protection, and dependable suspension. Engineered with a soft gel interface and durable outer fabric, it helps distribute pressure evenly while enhancing socket fit and everyday wear.',
    overview: [
