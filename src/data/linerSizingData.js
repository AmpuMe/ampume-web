...
export const SIZING_CHARTS = {
  ...
  'easyliner': {
    ...
    // Measured-circumference first, then size. Two availability columns.
    reverseColumns: true,
    showAvailability: true,
    sizes: [
      { label: '10', circumference: [10, 15], locking: null,          cushion: '3mm / 6mm' },
      { label: '16', circumference: [16, 19], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '20', circumference: [20, 23], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '24', circumference: [24, 25], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '26', circumference: [26, 27], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '28', circumference: [28, 31], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '32', circumference: [32, 34], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '35', circumference: [35, 37], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '38', circumference: [38, 43], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '44', circumference: [44, 53], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
    ],
    columns: [
      { key: 'circumference', header: 'Measured Circumference' },
      { key: 'label', header: 'Size' },
    ],
    note: 'Size 10 is only available in Cushion. All other sizes come in both Locking and Cushion configurations.',
    globalMin: 10,
    globalMax: 53,
  },
  ...
  'alps-gp': {
    ...
    sizes: [
      ...
      { label: '38',      circumference: [38, 43], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: '44',      circumference: [44, 53], locking: '3mm / 6mm',   cushion: '3mm / 6mm' },
      { label: 'X-Large', circumference: null,     locking: '3mm only',    cushion: null },
    ],
    columns: [
      { key: 'circumference', header: 'Measured Circumference' },
      { key: 'label', header: 'Size' },
    ],
    note: 'X-Large is only available in Locking 3mm. All other sizes come in Locking and Cushion, in both 3mm and 6mm thicknesses.',
    globalMin: 16,
    globalMax: 53,
  },
