    ...
    <footer className="bg-black text-white pt-24 pb-12 px-6 md:px-12 border-t border-white/10">
      <div className="grid grid-cols-12 gap-8 mb-24">
        ...
        <div className="col-span-12 md:col-span-3 md:col-start-10">
          <h3 className="text-xs font-bold uppercase tracking-widest mb-8 text-gray-400">Connect</h3>
          <div className="flex gap-4">
            <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all">
            ...
            <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all">
