...
export const CATEGORY_ORDER = [
  {
    ...
    id: 'liners',
    description: 'Prosthetic liners designed for comfort, protection, and secure fit.',
    icon: 'Shield',
  },
  {
    key: 'Prosthetic Sock',
  ...
  },
  {
    ...
    id: 'sleeves',
    description: 'Prosthetic sleeves designed to maintain suspension and keep your prosthesis secure and comfortable.',
    icon: 'Grip',
  },
  {
    key: 'Prosthetic Accessory',
    label: 'Care and Accessories',
    id: 'accessories',
